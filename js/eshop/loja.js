...
let chewbacca = document.querySelector("#chew");
...
chewbacca.addEventListener("click", () => {
  compraProduto(
    "Papo com o Dr. Chewbacca",
    "https://cdn.discordapp.com/attachments/770006003416563736/816811813076860999/favpng_chewbacca-star-wars-battlefront-ii-anakin-skywalker-luke-skywalker-han-solo.png",
    "200.000,00",
    "NeedForSpace™ and Disney™"
  );
});
...
kryptonita.addEventListener("click", () => {
  compraProduto(
    "Kryptonita",
